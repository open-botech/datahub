...
public class FieldExtractor {
  ...
  public static List<String> extractDataFieldsFromDataset(DatasetSnapshot datasetSnapshot ) {
    List<String> result = new ArrayList<>();
    for (DatasetAspect datasetAspect : datasetSnapshot.getAspects()) {
       if(datasetAspect.getSchemaMetadata()!=null){
        for (SchemaField field : datasetAspect.getSchemaMetadata().getFields()) {
